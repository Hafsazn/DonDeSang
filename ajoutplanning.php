...
if(isset($_POST['Ajouter'])) {
   ...
   if(!empty($_POST['Id_planning']) AND !empty($_POST['Personnel']) AND !empty($_POST['Salle']) AND !empty($_POST['Type']) AND !empty($_POST['Date']) AND !empty($_POST['Heure_de']) AND !empty($_POST['Heure_a'])) {
            ...
            try{
                    // echo "hello";
                     ...
                     $query = "INSERT INTO planning (Id_planning, Personnel, Salle, Type, Date, Heure_de, Heure_a) VALUES ('$id', '$personnel', '$salle', '$type', '$date', '$heurede', '$heurea')";
