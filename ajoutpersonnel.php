...
if(isset($_POST['Ajouter'])) {
   ...
   if(!empty($_POST['Id_personnel']) AND !empty($_POST['Nom']) AND !empty($_POST['Prenom']) AND !empty($_POST['Email']) AND !empty($_POST['Mdp']) AND !empty($_POST['Sexe']) AND !empty($_POST['Poste']) AND !empty($_POST['Droit'])) {
